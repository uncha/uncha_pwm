...
app.use(function (req, res, next) {
    ...
    res.setHeader('Access-Control-Allow-Origin', 'http://44.202.126.254:3000');
    res.setHeader('Access-Control-Allow-Origin', 'http://44.202.126.254:3001');
...
// app.get('/api/executionQuest/:groupId', function(req, res) {
//   let sql = `SELECT * FROM execution_quest WHERE group_id="${req.params.groupId} ORDER BY execution_date"`
//   con.query(sql, function (err, result, fields) {
//     if (err) throw err;
//     res.json(result)
//   });
...
// app.post('/api/executionQuest', function(req, res){
//   let sql = `INSERT INTO execution_quest (title, group_id, execution_date) VALUES ("${req.body.title}", "${req.body.group_id}", "${req.body.execution_date}")`
//   con.query(sql, function(err, result){
//       if(err) throw err;
//       res.json(result)
//   })
...
//   sql = `UPDATE execution_quest SET execution_pic="${req.body.execution_pic}", complete_state="1" WHERE id="${req.params.questId}"`
//   con.query(sql, function(err, result) {
//     if(err) throw err;
//     res.json(result);
//   })
...
// app.post('/api/executionQuestConfirm/:questId', function(req, res){
//   let sql = `UPDATE execution_quest SET success_state="${req.body.success_state}" WHERE id="${req.params.questId}"`
//   con.query(sql, function(err, result){
//       if(err) throw err;
//       res.json(result)
//   })
